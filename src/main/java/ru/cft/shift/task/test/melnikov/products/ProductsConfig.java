...
public class ProductsConfig {
    ...
    CommandLineRunner commandLineRunner(ProductRepository productRepository) {
        return args -> {
            ...
            products.add(new DesktopComputer(1, 15, "Intel", 15.4, 5, DesktopComputer.FormFactor.DESKTOP));
            products.add(new HardDrive(2, 18, "AMD", 5.33, 77, 256L * 1024));
            products.add(new Laptop(3, 1, "LOL", 9.87, 1, Laptop.Size.THIRTEEN));
            products.add(new Monitor(4, 89, "Kek", 1.15, 0, 13));
